...
The following example is a complete sample application that uses the `HostBuilder` to start a console service, and then schedules a managed task that reports progress.

[Dotnet Fiddle Example](https://dotnetfiddle.net/ZLhpLf)
...
```
Task Status: count to 5, Status: Scheduled
Task Status: count to 5, Status: Running
Task Progress: count to 5, Step: step: 1
Task Progress: count to 5, Step: step: 2
Task Progress: count to 5, Step: step: 3
Task Progress: count to 5, Step: step: 4
Task Progress: count to 5, Step: step: 5
Task Status: count to 5, Status: Completed
Task Status: count to 5, Status: Scheduled
... continues to repeat
```
